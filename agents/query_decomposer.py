...
_SYSTEM = """The user asked a multi-part question. Break it into 2-4 independent sub-queries
that can each be answered separately from a technical documentation knowledge base.
Return JSON: {"sub_queries": ["query1", "query2", ...]}
If the question is actually single-part, return {"sub_queries": ["<original query>"]}."""
